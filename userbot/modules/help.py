...
from .. import app
from ..pyrogram import CMD_HELP
from config import PREFIX
from ..helpers.pyrohelper import split_list

heading = "──「 **{0}** 」──\n"


@app.on_message(filters.command("help", PREFIX) & filters.me)
async def module_help(_, message):
    cmd = message.command
    ...
    if len(cmd) > 1:
        ...
        all_commands += f"**Do .help [module_name] for plugin info**\n\n"
